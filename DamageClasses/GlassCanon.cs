...
namespace InverseMod.DamageClasses
{
    public class GlassCanon : DamageClass
    {
        ...
        public override void SetDefaultStats(Player player)
        {
            ...
            player.GetCritChance<GlassCanon>() += 4;
            player.GetArmorPenetration<GlassCanon>() += 10;
            player.GetDamage<GlassCanon>() += 20;
            player.GetAttackSpeed<GlassCanon>() -= 3;
