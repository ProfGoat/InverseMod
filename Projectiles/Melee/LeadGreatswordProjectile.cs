...
{
    public class LeadGreatswordProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustPerfect(Projectile.Center, DustID.Granite, Velocity: Vector2.Zero, Scale: 1f);
        }
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (target.type != NPCID.TargetDummy && !target.boss)
            {
                ...
                // Optional: Add any additional effects upon hitLeadg the NPC here
            }
