...
{
    public class PlatinumGreatswordProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustPerfect(Projectile.Center, DustID.PlatinumCoin, Velocity: Vector2.Zero, Scale: 1f);
        }
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (target.type != NPCID.TargetDummy && !target.boss)
            {
                ...
                // Optional: Add any additional effects upon hitPlatinumg the NPC here
            }
