...
namespace InverseMod.Mounts
{
    class CopalMinecart : ModMount
    {
        public override void SetStaticDefaults()
        {
            ...
            MountData.runSpeed = 22;
            MountData.dashSpeed = 19;
            MountData.fallDamage = 0.5f;
            MountData.jumpHeight = 20;
            MountData.spawnDust = DustID.AmberBolt;
            MountData.jumpSpeed = 5.65f;
            MountData.flightTimeMax = 0;
            MountData.acceleration = 0.18f;
            MountData.blockExtraJumps = true;
            MountData.buff = ModContent.BuffType<Buffs.CopalMinecartBuff>();
