...
{
    class TourmalineMinecart : ModMount
    {
        public override void SetStaticDefaults()
        {
            ...
            MountData.dashSpeed = 15;
            MountData.fallDamage = 0.9f;
            MountData.jumpHeight = 16;
            MountData.spawnDust = ModContent.DustType<TourmalineTwinfireDust>();
            MountData.jumpSpeed = 5.25f;
            MountData.flightTimeMax = 0;
            MountData.acceleration = 0.1f;
            MountData.blockExtraJumps = true;
            MountData.buff = ModContent.BuffType<Buffs.TourmalineMinecartBuff>();
