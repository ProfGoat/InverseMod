...
{
    public class CopalMinecartItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Copal Minecart");
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true;
            Item.mountType = ModContent.MountType<CopalMinecart>();
        }
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(null, "LargeCopal", 1);
