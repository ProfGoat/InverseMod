...
{
    public class JadeMinecartItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Jade Minecart");
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true;
            Item.mountType = ModContent.MountType<JadeMinecart>();
        }
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(null, "LargeJade", 1);
