...
{
    public class GrapheneMinecartItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Graphene Minecart");
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true;
            Item.mountType = ModContent.MountType<GrapheneMinecart>();
        }
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(null, "LargeGraphene", 1);
