...
{
    public class LargeCopal : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Large Copal");
        ...
        int whoAmI)
        {
            Texture2D texture2D = ModContent.Request<Texture2D>("InverseMod/Items/LargeGems/LargeCopal").Value;
