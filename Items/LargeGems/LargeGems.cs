...
{
    public class LargeGems : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            Mod mod = InverseMod.Instance;
            InversePlayer inversePlayer = drawPlayer.GetModPlayer<InversePlayer>();
            if (inversePlayer.hasLargeGems == 0)
                return;
            BitsByte ownedLargeGems = inversePlayer.ownedLargeGems;
            BitsByte hasLargeGems = inversePlayer.hasLargeGems;
            int num1 = 0;
            ...
            {
                    "InverseMod/Items/LargeGems/LargeCitrineGlow",
                    "InverseMod/Items/LargeGems/LargeTourmalineGlow",
                    "InverseMod/Items/LargeGems/LargeTanzaniteGlow",
                    "InverseMod/Items/LargeGems/LargeJadeGlow",
                    "InverseMod/Items/LargeGems/LargeGarnetGlow",
                    "InverseMod/Items/LargeGems/LargeCopalGlow",
                    "InverseMod/Items/LargeGems/LargeGrapheneGlow",
            };
