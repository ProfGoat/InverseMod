...
{
    public class LargeTanzanite : ModItem
    {
        ...
        int whoAmI)
        {
            Texture2D texture2D = ModContent.Request<Texture2D>("InverseMod/Items/LargeGems/LargeTanzanite").Value;
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(null, "Tanzanite", 15);
