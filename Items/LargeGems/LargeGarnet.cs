...
namespace InverseMod.Items.LargeGems
{
    public class LargeGarnet : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Large Garnet");
        ...
        int whoAmI)
        {
            Texture2D texture2D = ModContent.Request<Texture2D>("InverseMod/Items/LargeGems/LargeGarnet").Value;
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(null, "Garnet", 15);
