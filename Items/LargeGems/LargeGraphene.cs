...
{
    public class LargeGraphene : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Main.RegisterItemAnimation(Item.type, new DrawAnimationVertical(4, 40));
        ...
        int whoAmI)
        {
            Texture2D texture2D = ModContent.Request<Texture2D>("InverseMod/Items/LargeGems/LargeGraphene").Value;
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(null, "Graphene", 15);
