...
namespace InverseMod.Items.LargeGems
{
    public class LargeJade : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Large Jade");
        ...
        int whoAmI)
        {
            Texture2D texture2D = ModContent.Request<Texture2D>("InverseMod/Items/LargeGems/LargeJade").Value;
