...
{
    public class LargeCitrine : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Large Citrine");
        ...
        int whoAmI)
        {
            Texture2D texture2D = ModContent.Request<Texture2D>("InverseMod/Items/LargeGems/LargeCitrine").Value;
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(null, "Citrine", 15);
