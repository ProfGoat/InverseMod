...
{
    public class TungstenGreatsword : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.useAnimation = 35; // Standard swing animation
            Item.useTime = 35; // Standard use time
            Item.width = 62;
            Item.height = 62;
            ...
            Item.value = Item.sellPrice(0, 0, 16, 20);
