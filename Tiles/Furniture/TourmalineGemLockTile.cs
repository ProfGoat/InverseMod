...
{
    public class TourmalineGemLockTile : ModTile
    {
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    gemLock = Mod.Find<ModItem>("TourmalineGemLock").Type;
                    break;
            }
            if (gemLock > 0)
            {
        ...
        public static void Toggle(int i, int j, bool turnOn)
        {
            ...
            Mod mod = ModLoader.GetMod("InverseMod");
            if (!tile.HasTile || tile.TileType != mod.Find<ModTile>("TourmalineGemLockTile").Type)
                return;
        ...
        public static int SelectGem(short frameX)
        {
            ...
            {
                case 0:
                    gem = mod.Find<ModItem>("LargeTourmaline").Type;
                    break;
            }
            return gem;
        }
