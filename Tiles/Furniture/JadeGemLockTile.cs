...
{
    public class JadeGemLockTile : ModTile
    {
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    gemLock = Mod.Find<ModItem>("JadeGemLock").Type;
                    break;
            }
            if (gemLock > 0)
            {
        ...
        public static void Toggle(int i, int j, bool turnOn)
        {
            ...
            if (!tile.HasTile || tile.TileType != mod.Find<ModTile>("JadeGemLockTile").Type)
                return;
        ...
        public static int SelectGem(short frameX)
        {
            ...
            {
                case 0:
                    gem = mod.Find<ModItem>("LargeJade").Type;
                    break;
            }
            return gem;
        }
