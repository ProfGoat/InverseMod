...
namespace InverseMod.Tiles.Furniture
{
    public class PeasantSlimeRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "InverseMod/Tiles/Furniture/PeasantSlimeRelic";

        public override string Texture => "InverseMod/Tiles/Furniture/RelicPedestal";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<Items.Furniture.PeasantSlimeRelic>();
                    break;
            }
