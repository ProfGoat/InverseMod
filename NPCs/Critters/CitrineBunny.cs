...
{
    public class CitrineBunny : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Citrine Bunny");
        ...
        public override void SetDefaults()
        {
            ...
            NPC.aiStyle = 7;
            NPC.catchItem = (short)ModContent.ItemType<Items.Consumables.CitrineBunny>();
            AIType = NPCID.Bunny;
        ...
        public override void OnKill()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                int dustIndex = Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.GemTopaz);
