...
{
    public class JadeSquirrel : ModNPC
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Jade Squirrel");
        ...
        public override void SetDefaults()
        {
            ...
            NPC.aiStyle = 7;
            NPC.catchItem = (short)ModContent.ItemType<Items.Consumables.JadeSquirrel>();
        ...
        public override void OnKill()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                int dustIndex = Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.GemEmerald);
